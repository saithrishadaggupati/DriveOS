...
public abstract class Hilt_HVACFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HVACFragment_GeneratedInjector) this.generatedComponent()).injectHVACFragment(UnsafeCasts.<HVACFragment>unsafeCast(this));
    }
  }
