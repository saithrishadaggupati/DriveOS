...
public abstract class Hilt_DiagnosticsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DiagnosticsFragment() {
    super();
  }

  Hilt_DiagnosticsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiagnosticsFragment_GeneratedInjector) this.generatedComponent()).injectDiagnosticsFragment(UnsafeCasts.<DiagnosticsFragment>unsafeCast(this));
    }
  }
