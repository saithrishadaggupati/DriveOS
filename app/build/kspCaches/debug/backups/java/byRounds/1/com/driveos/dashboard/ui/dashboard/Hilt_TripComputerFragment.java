...
public abstract class Hilt_TripComputerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TripComputerFragment() {
    super();
  }

  Hilt_TripComputerFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TripComputerFragment_GeneratedInjector) this.generatedComponent()).injectTripComputerFragment(UnsafeCasts.<TripComputerFragment>unsafeCast(this));
    }
  }
